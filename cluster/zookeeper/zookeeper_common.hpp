...
#ifndef LFGRAPH_ZOOKEEPER_COMMON_HPP
#define LFGRAPH_ZOOKEEPER_COMMON_HPP
#include <vector>
#include <string>
...
std::vector< std::pair<size_t, std::string> > String_vector_to_pair_vector_int(
    const struct String_vector* strings);
